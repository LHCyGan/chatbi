...
import com.lhcygan.chatbibackend.model.dto.chart.*;
...
import com.lhcygan.chatbibackend.model.vo.BiResponse;
import com.lhcygan.chatbibackend.rabbitmq.RabbitMqMessageProducer;
...
public class ChartController {
    ...
    public BaseResponse<BiResponse> genChartByAiAsyncMq(@RequestPart("file") MultipartFile multipartFile,
        ...
        chart.setStatus(ExecStatusEnum.WAIT.getValue());
        chart.setUserId(loginUser.getId());
        boolean saveResult = chartService.save(chart);
        ThrowUtils.throwIf(!saveResult, ErrorCode.SYSTEM_ERROR, "图表保存失败");

        long newChartId = chart.getId();
        rabbitMqMessageProducer.sendMessage(String.valueOf(newChartId));
